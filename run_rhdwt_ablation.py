"""Run RHDWT and RHDWT-QPA downsampling ablations."""
...
MODELS = (
    "two_block_rhdwt_classical_cnn",
    "two_block_rhdwt_qpa_classical_cnn",
    "two_block_rhdwt_qpa_qpa_cnn",
)
...
def main():
    ...
    for dataset in (item.strip() for item in args.datasets.split(",")):
        ...
        config_dir = ROOT / "configs" / f"generated_{dataset}_rhdwt_ablation"
        log_dir = ROOT / "study_logs" / "rhdwt_ablation"
