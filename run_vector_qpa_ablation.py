"""Run the SEQNN-inspired four-dimensional QPA ablation."""
...
MODELS = (
    "two_block_vector_dwt_qpa_classical_cnn",
    "two_block_vector_dwt_qpa_qpa_cnn",
)
...
def main():
    ...
    for dataset in (item.strip() for item in args.datasets.split(",")):
        ...
        config_dir = ROOT / "configs" / f"generated_{dataset}_vector_qpa"
        log_dir = ROOT / "study_logs" / "vector_qpa"
