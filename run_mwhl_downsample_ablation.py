"""Run MWHL-style DWT-QPA downsampling between the two ResBlocks."""
...
MODELS = (
    "two_block_mwhl_downsample_classical_cnn",
    "two_block_mwhl_downsample_qpa_cnn",
)
...
def main():
    ...
    for dataset in (item.strip() for item in args.datasets.split(",")):
        ...
        config_dir = ROOT / "configs" / f"generated_{dataset}_mwhl_downsample"
        log_dir = ROOT / "study_logs" / "mwhl_downsample"
