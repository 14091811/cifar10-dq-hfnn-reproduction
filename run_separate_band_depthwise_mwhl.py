"""Run MWHL with independent LH/HL/HH depthwise value gates."""
...
MODELS = (
    "two_block_separate_band_depthwise_mwhl_classical_cnn",
    "two_block_separate_band_depthwise_mwhl_qpa_cnn",
)
...
def main():
    ...
    for dataset in (item.strip() for item in args.datasets.split(",")):
        ...
        config_dir = ROOT / "configs" / f"generated_{dataset}_separate_band_depthwise_mwhl"
        log_dir = ROOT / "study_logs" / "separate_band_depthwise_mwhl"
