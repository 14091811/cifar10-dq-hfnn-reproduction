"""Run DWT-QPA with PoM-generated high-frequency value gates."""
...
MODELS = (
    "two_block_dwt_qpa_frequency_pom_classical_cnn",
    "two_block_dwt_qpa_frequency_pom_qpa_cnn",
)
...
def main():
    ...
    for dataset in (item.strip() for item in args.datasets.split(",")):
        ...
        config_dir = ROOT / "configs" / f"generated_{dataset}_frequency_pom_gate"
        log_dir = ROOT / "study_logs" / "frequency_pom_gate"
