"""Compare explicit DWT high-frequency fusion against the MWHL spatial fusion."""
...
MODELS = (
    "two_block_high_frequency_downsample_classical_cnn",
    "two_block_high_frequency_downsample_qpa_cnn",
)
...
def main():
    ...
    for dataset in (item.strip() for item in args.datasets.split(",")):
        ...
        config_dir = ROOT / "configs" / f"generated_{dataset}_high_frequency_downsample"
        log_dir = ROOT / "study_logs" / "high_frequency_downsample"
