"""Compare standard-convolution LH/HL value gates on two binary datasets."""
...
MODELS = (
    "two_block_dwt_directional_classical_standard_value_gate_d16_cnn",
    "two_block_dwt_directional_qpa_standard_value_gate_d16_cnn",
)
...
def main():
    ...
    for dataset in datasets:
        ...
        output_dir = ROOT / "configs" / f"generated_{dataset}_standard_conv_value_gate"
    ...
    print("Standard-convolution LH/HL value gate study complete", flush=True)
