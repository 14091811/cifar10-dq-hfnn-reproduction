"""Run the MWHL-style LL/original-spatial fusion DWT-QPA diagnostic."""
...
MODELS = (
    "two_block_mwhl_fused_full_channel_dwt_classical_cnn",
    "two_block_mwhl_fused_full_channel_dwt_qpa_cnn",
)
...
def main():
    ...
    for dataset in (item.strip() for item in args.datasets.split(",")):
        ...
        config_dir = ROOT / "configs" / f"generated_{dataset}_mwhl_fused_dwt"
        log_dir = ROOT / "study_logs" / "mwhl_fused_dwt"
