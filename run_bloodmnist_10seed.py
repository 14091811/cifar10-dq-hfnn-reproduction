"""Run the complete BloodMNIST 10-seed 2x2 fixed-50 comparison."""
...
DEFAULT_CONFIG = ROOT / "configs" / "bloodmnist_2x2_fixed50.json"
...
def main():
    ...
    if base_config.get("dataset") != "bloodmnist":
        raise ValueError(f"expected bloodmnist config, got {base_config.get('dataset')!r}")

    seeds = parse_seeds(args.seeds)
    output_dir = ROOT / "configs" / "generated_bloodmnist"
    ...
    print("BloodMNIST 10-seed study complete", flush=True)
