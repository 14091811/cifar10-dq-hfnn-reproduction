...
from dq_hfnn.local_spa import (
    ...
    TwoBlockChannelWiseDWTQuantumCNN,
    TwoBlockChannelWiseDWTClassicalOneHeadCNN,
    TwoBlockChannelWiseDWTQuantumOneHeadCNN,
    TwoBlockFullChannelDWTClassicalCNN,
    TwoBlockFullChannelDWTQuantumCNN,
    TwoBlockMWHLFusedFullChannelDWTClassicalCNN,
    TwoBlockMWHLFusedFullChannelDWTQuantumCNN,
    TwoBlockMWHLDownsampleClassicalCNN,
    TwoBlockMWHLDownsampleQuantumCNN,
    TwoBlockSeparateBandDepthwiseMWHLClassicalCNN,
    TwoBlockSeparateBandDepthwiseMWHLQuantumCNN,
    TwoBlockHighFrequencyDownsampleClassicalCNN,
    TwoBlockHighFrequencyDownsampleQuantumCNN,
    TwoBlockDBDMClassicalCNN,
    TwoBlockDWTQPADBDMClassicalCNN,
    TwoBlockDWTQPADBDMQuantumCNN,
    TwoBlockDWTQPAFrequencyPoMClassicalCNN,
    TwoBlockDWTQPAFrequencyPoMQuantumCNN,
    TwoBlockVectorDWTQPAClassicalCNN,
    TwoBlockVectorDWTQPAQuantumCNN,
    TwoBlockRHDWTClassicalCNN,
    TwoBlockRHDWTQPAClassicalCNN,
    TwoBlockRHDWTQPAQuantumCNN,
    TwoBlockRHDWTQPAClassicalD64CNN,
    TwoBlockRHDWTQPAQuantumD64CNN,
...
MODELS = {
    ...
    "two_block_channelwise_dwt_qpa_cnn": TwoBlockChannelWiseDWTQuantumCNN,
    "two_block_channelwise_dwt_classical_onehead_cnn": TwoBlockChannelWiseDWTClassicalOneHeadCNN,
    "two_block_channelwise_dwt_qpa_onehead_cnn": TwoBlockChannelWiseDWTQuantumOneHeadCNN,
    "two_block_full_channel_dwt_classical_cnn": TwoBlockFullChannelDWTClassicalCNN,
    "two_block_full_channel_dwt_qpa_cnn": TwoBlockFullChannelDWTQuantumCNN,
    "two_block_mwhl_fused_full_channel_dwt_classical_cnn": TwoBlockMWHLFusedFullChannelDWTClassicalCNN,
    "two_block_mwhl_fused_full_channel_dwt_qpa_cnn": TwoBlockMWHLFusedFullChannelDWTQuantumCNN,
    "two_block_mwhl_downsample_classical_cnn": TwoBlockMWHLDownsampleClassicalCNN,
    "two_block_mwhl_downsample_qpa_cnn": TwoBlockMWHLDownsampleQuantumCNN,
    "two_block_separate_band_depthwise_mwhl_classical_cnn": TwoBlockSeparateBandDepthwiseMWHLClassicalCNN,
    "two_block_separate_band_depthwise_mwhl_qpa_cnn": TwoBlockSeparateBandDepthwiseMWHLQuantumCNN,
    "two_block_high_frequency_downsample_classical_cnn": TwoBlockHighFrequencyDownsampleClassicalCNN,
    "two_block_high_frequency_downsample_qpa_cnn": TwoBlockHighFrequencyDownsampleQuantumCNN,
    "two_block_dbdm_classical_cnn": TwoBlockDBDMClassicalCNN,
    "two_block_dwt_qpa_dbdm_classical_cnn": TwoBlockDWTQPADBDMClassicalCNN,
    "two_block_dwt_qpa_dbdm_qpa_cnn": TwoBlockDWTQPADBDMQuantumCNN,
    "two_block_dwt_qpa_frequency_pom_classical_cnn": TwoBlockDWTQPAFrequencyPoMClassicalCNN,
    "two_block_dwt_qpa_frequency_pom_qpa_cnn": TwoBlockDWTQPAFrequencyPoMQuantumCNN,
    "two_block_vector_dwt_qpa_classical_cnn": TwoBlockVectorDWTQPAClassicalCNN,
    "two_block_vector_dwt_qpa_qpa_cnn": TwoBlockVectorDWTQPAQuantumCNN,
    "two_block_rhdwt_classical_cnn": TwoBlockRHDWTClassicalCNN,
    "two_block_rhdwt_qpa_classical_cnn": TwoBlockRHDWTQPAClassicalCNN,
    "two_block_rhdwt_qpa_qpa_cnn": TwoBlockRHDWTQPAQuantumCNN,
    "two_block_rhdwt_qpa_classical_d64_cnn": TwoBlockRHDWTQPAClassicalD64CNN,
    "two_block_rhdwt_qpa_qpa_d64_cnn": TwoBlockRHDWTQPAQuantumD64CNN,
