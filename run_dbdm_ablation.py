"""Compare DBDM downsampling with DWT-QPA followed by DBDM."""
...
MODELS = (
    "two_block_dbdm_classical_cnn",
    "two_block_dwt_qpa_dbdm_classical_cnn",
    "two_block_dwt_qpa_dbdm_qpa_cnn",
)
...
def main():
    ...
    for dataset in (item.strip() for item in args.datasets.split(",")):
        ...
        config_dir = ROOT / "configs" / f"generated_{dataset}_dbdm_ablation"
        log_dir = ROOT / "study_logs" / "dbdm_ablation"
