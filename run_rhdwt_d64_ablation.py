"""Run the full 64-dimensional RHDWT-QPA ablation without bypass channels."""
...
MODELS = (
    "two_block_rhdwt_qpa_classical_d64_cnn",
    "two_block_rhdwt_qpa_qpa_d64_cnn",
)
...
def main():
    ...
    for dataset in (item.strip() for item in args.datasets.split(",")):
        ...
        config_dir = ROOT / "configs" / f"generated_{dataset}_rhdwt_d64"
        log_dir = ROOT / "study_logs" / "rhdwt_d64"
