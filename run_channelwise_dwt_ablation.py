"""Run channel-token DWT-QPA on the fixed binary MedMNIST protocol."""
...
MODELS = (
    "two_block_channelwise_dwt_classical_cnn",
    "two_block_channelwise_dwt_qpa_cnn",
)
...
def main():
    ...
    for dataset in (item.strip() for item in args.datasets.split(",")):
        ...
        config_dir = ROOT / "configs" / f"generated_{dataset}_channelwise_dwt"
        log_dir = ROOT / "study_logs" / "channelwise_dwt"
