"""Run the non-residual partial-channel DWT-QPA diagnostic."""
...
MODELS = (
    "two_block_partial_channel_dwt_classical_cnn",
    "two_block_partial_channel_dwt_qpa_cnn",
)
...
def main():
    ...
    for dataset in parse_csv(args.datasets):
        ...
        config_dir = ROOT / "configs" / f"generated_{dataset}_partial_channel_dwt"
        log_dir = ROOT / "study_logs" / "partial_channel_dwt"
